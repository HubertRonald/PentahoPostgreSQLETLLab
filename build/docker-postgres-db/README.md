...
```bash
curl -l https://github.com/Microsoft/sql-server-samples/releases/download/adventureworks/AdventureWorks-oltp-install-script.zip > adventure_works_2014_OLTP_script.zip
```
